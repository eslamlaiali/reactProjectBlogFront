...
export default function NotFound() {
  return (
    <div className="relative min-h-full overflow-hidden z-[-1]">
      <div className="notfound-copy relative z-10 pt-16 pr-10">
        <svg
          aria-labelledby="404"
      ...
      <svg
        className="starry-sky fixed inset-0 w-full h-full max-h-screen object-cover bg-[#0a1821]"
